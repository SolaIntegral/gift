...
# Plamo API設定（本番環境用）
VITE_PLAMO_API_KEY=cjh4ajE2czZ3ODJpb2wxanFiMG06bnUlJnpneEV1dXJ1dFNHYjBYbHo5S0N5NjRBJmx0Mmk=
VITE_PLAMO_BASE_URL=https://platform.preferredai.jp/api/completion
VITE_PLAMO_MODEL=plamo-2.0-prime

# Supabase設定（本番環境用）
VITE_SUPABASE_URL=https://zmconnflcrsqdzkpojak.supabase.co
VITE_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InptY29ubmZsY3JzcWR6a3BvamFrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTQ0NzczMTgsImV4cCI6MjA3MDA1MzMxOH0.2FVV6YELMlgpyHyFcPDhejcxQHrRxDI95_wF4N-eG3Y
EOF
